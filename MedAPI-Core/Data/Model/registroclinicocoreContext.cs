    ...
    public partial class registroclinicocoreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cardiovascularnote>(entity =>
            {
                ...
                entity.Property(e => e.AuscultationSite)
                    .HasMaxLength(255)
                    .HasColumnName("auscultationSite");

                entity.Property(e => e.CapillaryRefillLlm)
                    .HasMaxLength(255)
                    .HasColumnName("capillaryRefillLLM");

                entity.Property(e => e.CapillaryRefillLrm)
                    .HasMaxLength(255)
                    .HasColumnName("capillaryRefillLRM");

                entity.Property(e => e.CardiacPressureIntensity)
                    .HasMaxLength(255)
                    .HasColumnName("cardiacPressureIntensity");

                entity.Property(e => e.CardiacPressureRhythm)
                    .HasMaxLength(255)
                    .HasColumnName("cardiacPressureRhythm");

                entity.Property(e => e.DiastolicPhase).HasColumnName("diastolicPhase");

                entity.Property(e => e.EdemaAnkle).HasColumnName("edemaAnkle");

                entity.Property(e => e.EdemaGeneralized).HasColumnName("edemaGeneralized");

                entity.Property(e => e.EdemaLowerMembers).HasColumnName("edemaLowerMembers");

                entity.Property(e => e.FourthNoise).HasColumnName("fourthNoise");

                entity.Property(e => e.GastrointestinalSemiology)
                    .HasMaxLength(255)
                    .HasColumnName("gastrointestinalSemiology");

                entity.Property(e => e.IsDelete).HasColumnName("isDelete");

                entity.Property(e => e.Murmurs).HasColumnName("murmurs");

                entity.Property(e => e.NeckRadiation).HasColumnName("neckRadiation");

                entity.Property(e => e.NoteId).HasColumnName("note_id");

                entity.Property(e => e.OtherSymptoms)
                    .HasMaxLength(255)
                    .HasColumnName("otherSymptoms");

                entity.Property(e => e.PedalPulsesL)
                    .HasMaxLength(255)
                    .HasColumnName("pedalPulsesL");

                entity.Property(e => e.PedalPulsesR)
                    .HasMaxLength(255)
                    .HasColumnName("pedalPulsesR");

                entity.Property(e => e.PulsesLlm)
                    .HasMaxLength(255)
                    .HasColumnName("pulsesLLM");

                entity.Property(e => e.PulsesLrm)
                    .HasMaxLength(255)
                    .HasColumnName("pulsesLRM");

                entity.Property(e => e.RadialPulsesL)
                    .HasMaxLength(255)
                    .HasColumnName("radialPulsesL");

                entity.Property(e => e.RadialPulsesR)
                    .HasMaxLength(255)
                    .HasColumnName("radialPulsesR");

                entity.Property(e => e.SystolicPhase).HasColumnName("systolicPhase");

                entity.Property(e => e.ThirdNoise).HasColumnName("thirdNoise");

                entity.Property(e => e.TrophicChanges).HasColumnName("trophicChanges");

                entity.Property(e => e.VesicularWhisperL)
                    .HasMaxLength(255)
                    .HasColumnName("vesicularWhisperL");

                entity.Property(e => e.VesicularWhisperR)
                    .HasMaxLength(255)
                    .HasColumnName("vesicularWhisperR");
